package com.bentonian.jogldemos.morph;
...
public class MorphDemo extends JoglDemo {
  ...
  public void init(GLAutoDrawable glDrawable) {
    ...
    getCamera().setIdentity().translate(new M3d(0, 0, 3));
  }
  ...
  Generator sphere = new Generator() { @Override
  ...
  Generator powerSphere = new Generator() { @Override
  public M3d get(double u, double v) {
    u = 2 * PI * u;
    v = PI * (v-0.5);
  ...
  Generator cylinder = new Generator() { @Override
  public M3d get(double u, double v) {
    u = 2 * PI * u;
    v = 2 * (v-0.5);
  ...
  Generator torus = new Generator() { @Override
  public M3d get(double u, double v) {
    M3d pt;
  ...
  public static void main(String[] args) {
    JoglDemoContainer.go(new MorphDemo());
  }
}
