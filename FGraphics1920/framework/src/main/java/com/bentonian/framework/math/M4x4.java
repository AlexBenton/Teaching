...
public class M4x4 {
  ...
  public M4x4 setRow(int row, Vec3 value) {
    for (int i = 0; i < 3; i++) {
  ...
  public M4x4 setCol(int col, Vec3 value) {
    for (int i = 0; i < 3; i++) {
  ...
  public static M4x4 translationMatrix(Vec3 t) {
    M4x4 M = new M4x4();
    for (int i = 0; i < 3; i++) {
      M.data[i][3] = t.get(i);
    }
  ...
  public static M4x4 scaleMatrix(Vec3 t) {
    M4x4 M = new M4x4();
    for (int i = 0; i < 3; i++) {
      M.data[i][i] = t.get(i);
    }
  ...
  public static M4x4 rotationMatrix(Vec3 axis, double phi) {
    M4x4 M = new M4x4();
  ...
  public M4x4 translated(Vec3 t) {
    return translationMatrix(t).times(this);
  }

  public M4x4 scaled(Vec3 t) {
    return scaleMatrix(t).times(this);
  }

  public M4x4 rotated(Vec3 axis, double phi) {
  ...
  public Vec3 getCol(int col) {
    return new Vec3(data[0][col], data[1][col], data[2][col]);
  }

  public Vec3 getRow(int row) {
    return new Vec3(data[row][0], data[row][1], data[row][2]);
  }
