...
public class Transformable {
  ...
  public Vec3 getPosition() {
    return localToParent.times(new Vec3(0,0,0));
  }
  ...
  public Transformable translate(Vec3 v) {
    return apply(M4x4.translationMatrix(v));
  }

  public Transformable rotate(Vec3 axis, double d) {
    return apply(M4x4.rotationMatrix(axis, d));
  }

  public Transformable scale(Vec3 v) {
