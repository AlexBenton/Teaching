...
public class Circle extends MeshPrimitiveWithTexture implements IsRayTraceable {
  ...
  private static final Material RING = new Material().setColor(new Vec3(0.2, 0.2, 1));
