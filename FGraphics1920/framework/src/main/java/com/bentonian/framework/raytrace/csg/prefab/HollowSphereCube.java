...
public class HollowSphereCube extends Intersection {
  ...
  private static final Primitive A = new Sphere().scale(new Vec3(200, 0.55, 0.55));
  private static final Primitive B = new Sphere().scale(new Vec3(0.55, 200, 0.55));
  private static final Primitive C = new Sphere().scale(new Vec3(0.55, 0.55, 200));
  private static final Primitive AXES = new Union(A, new Union(B, C));
  private static final Primitive D = new Cube().setColor(new Vec3(0.2, 0.5, 0.8)).scale(new Vec3(0.7, 0.7, 0.7));
  private static final Primitive E1 = new Sphere();
  private static final Primitive E2 = new Sphere().scale(new Vec3(0.85, 0.85, 0.85));
