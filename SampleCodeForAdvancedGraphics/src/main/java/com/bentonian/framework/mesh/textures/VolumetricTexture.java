...
public class VolumetricTexture {
  ...
  public static final Texture WOOD = new Texture() {
  ...
  public static final Texture PERLIN_FRACTAL = new Texture() {
  ...
  public static final Texture PERLIN_FRACTAL_FIRE = new Texture() {
  ...
  public static final Texture MARBLE = new Texture() {
